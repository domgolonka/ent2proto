...
import (
	"bytes"
	"fmt"
	"github.com/domgolonka/ent2proto/internal/load/internal"
...
// LoadConfig holds the LoadConfiguration for package building.
...
func (c *LoadConfig) Load() (*SchemaSpec, error) {
	pkgPath, err := c.load()
	if err != nil {
...
func (c *LoadConfig) load() (string, error) {
