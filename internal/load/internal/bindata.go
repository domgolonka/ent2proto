...
func templateMainTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/main.tmpl", size: 847, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
